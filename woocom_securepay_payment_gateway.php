...
function woocommerce_securepay_payment_gateway_init(){
    ...
    class woocommerce_securepay_p_gateway extends WC_Payment_Gateway{
        ...
        public function admin_options(){ ?>
			...
			<strong>Note:</strong> For test transaction please use, Merchant ID : <strong>ABC0001</strong> and Password: <strong>abc123</strong><br><br>If you have any queries, issues or feedback regarding the plugin, please contact developer at <a href="http://hemthapa.com?wp_securepay" target="_blank">http://hemthapa.com</a><br><hr>', 'woocommerce'); ?>
